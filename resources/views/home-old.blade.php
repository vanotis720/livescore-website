...
<body class="game_info" data-spy="scroll" data-target=".header">
    <!-- LOADER -->
    <div id="preloader">
        <img class="preloader" src="{{ asset('assets/images/loading-img.gif') }}" alt="">
    </div>
    <!-- END LOADER -->
    <section id="top">
        <header>
                            ...
                            <div class="right_top_section">
                                ...
                                <ul class="login">
                                    <li class="login-modal">
                                        <a href="#" class="login"><i class="fa fa-user"></i>Connexion</a>
                                    </li>
                                    <li>
                                        <div class="cart-option">
                                            <a href="#"><i class="fa fa-shopping-cart"></i>Inscription</a>
                                        </div>
                                    </li>
                                </ul>
                                <!-- end button section -->
                                        ...
                                        <nav class="navbar navbar-inverse">
                                            ...
                                            <div class="collapse navbar-collapse js-navbar-collapse">
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <li><a href="team.html">Competitions</a></li>
                                                    <!-- <li><a href="news.html">Matches</a></li> -->
                                                    <li class="dropdown mega-dropdown">
                                                        <a href="match" class="dropdown-toggle"
                                                            data-toggle="dropdown">Match a venir<span
                                                                class="caret"></span></a>
                                                        <ul class="dropdown-menu mega-dropdown-menu">
                                                            <li class="col-sm-12">
                                                                <ul class="menu-inner list-group">
                                                                    <li class="dropdown-header">Prochain Matchs</li>
                                                                    @foreach ($nextmatch->matches as $match)
                                                                        <li class="list-group-item list-group-item-action">
                                                                            <a href="match/{{ $match->id }}">
                                                                                {{ $match->homeTeam->name }} vs
                                                                                {{ $match->awayTeam->name }} <br>
                                                                                {{ \Carbon\Carbon::parse($match->utcDate)->toDateTimeString() }} GMT+0
                                                                            </a>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                    ...
                    <div class="matchs-vs">
                        <div class="vs-team">
                            <div class="team-btw-match">
                                <ul>
                                    <li>
                                        <img src="{{ asset('assets/images/img-03.png') }}" alt="">
                                        <span>Footbal Team</span>
                                    </li>
                                    <li class="vs"><span>vs</span></li>
                                    <li>
                                        <img src="{{ asset('assets/images/img-04.png') }}" alt="">
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12">
                    <aside id="sidebar" class="left-bar">
                        <div class="banner-sidebar">
                            <img class="img-responsive" src="{{ asset('assets/images/img-05.jpg') }}" alt="#" />
                    ...
                    <aside id="sidebar" class="left-bar">
                        <div class="feature-matchs">
                            <div class="team-btw-match">
                                <ul>
                                    <li>
                                        <img src="{{ asset('assets/images/img-01_002.png') }}" alt="">
                                        <span>Portugal</span>
                                    </li>
                                    <li class="vs"><span>vs</span></li>
                                    <li>
                                        <img src="{{ asset('assets/images/img-02.png') }}" alt="">
                                        <span>Germany</span>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
                                        <img src="{{ asset('assets/images/img-03_002.png') }}" alt="">
                                        <span>Portugal</span>
                                    </li>
                                    <li class="vs"><span>vs</span></li>
                                    <li>
                                        <img src="{{ asset('assets/images/img-04_003.png') }}" alt="">
                                        <span>Germany</span>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
                                        <img src="{{ asset('assets/images/img-05_002.png') }}" alt="">
                                        <span>Portugal</span>
                                    </li>
                                    <li class="vs"><span>vs</span></li>
                                    <li>
                                        <img src="{{ asset('assets/images/img-06.png') }}" alt="">
                                        <span>Germany</span>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
                                        <img src="{{ asset('assets/images/img-07_002.png') }}" alt="">
                                        <span>Portugal</span>
                                    </li>
                                    <li class="vs"><span>vs</span></li>
                                    <li>
                                        <img src="{{ asset('assets/images/img-08.png') }}" alt="">
                                        <span>Germany</span>
                                    </li>
                                </ul>
                                <ul>
